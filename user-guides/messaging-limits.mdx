...
<AccordionGroup>
  ...
  <Accordion title="'Chat Mode' credits consumption">
    ...
    So, 1 chat mode message = 1 edit mode message = 1 message&#x20;
  </Accordion>
