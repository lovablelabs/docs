...
* **Starter**
  ...
  : 5 daily (Up to 150 per month) and 100 monthly messages = 250 messages per month

* **Launch**

  : 5 daily and 250 monthly messages (2.5x paid limit) = 400 messages per month

* **Scale 1**

  : 5 daily and 500 monthly messages (5x paid limit) = 650 messages per month

* **Scale 2**

  : 5 daily and 1,000 monthly messages (10x paid limit) = 1,150 messages per month

* **Scale 3**

  : 5 daily and 1,500 monthly messages (15x paid limit) = 1,650 messages per month

* **Scale 4**

  : 5 daily and 2,000 monthly messages (20x paid limit) = 2,150 messages per month

* **Scale 5**

  : 5 daily and 3,000 monthly messages (30x paid limit) = 3,150 messages per month

* **Scale 6**

  : 5 daily and 4,000 monthly messages (40x paid limit) = 4,150 messages per month

* **Scale 7**

  : 5 daily and 5,000 monthly messages (50x paid limit) = 5,150 messages per month
...
* **No immediate changes**
   ...
   occur to your subscription.

* The downgrade will take effect at the 

  **start of the next billing period**

  , at which point you will be billed for the new, lower-cost plan.
