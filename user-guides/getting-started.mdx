...
2. Once connected to your Github repository, Do you want to edit the code directly? You can access your project on Github and make [changes to the code yourself](/features/git-integration).
