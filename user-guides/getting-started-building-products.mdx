...
<Note>
  Just like a human developer, AI will make mistakes. This is common and no reason to be alarmed. You can click on "Try to fix it" or use different approaches to help the AI fix an error. More in the "Iterate & handle errors" section (Coming soon)
</Note>
