...
<Steps>
  <Step title="Getting started with Lovable 101">
    ...
    <AccordionGroup>
      ...
      <Accordion title="Testing the Login System">
        <Steps>
        ...
        <Steps>
          <Step title="Modify Individual Components">
            ...
            <Info>
              ...
              _“Update the copy in the Welcome Card to make it more engaging.”_
            </Info>
          </Step>
          <Step title="Use Chat Mode for Refactoring">
            ...
            <Info>
              ...
              _“Refactor the dashboard into smaller, cleaner components.”_
            </Info>
        ...
        <Steps>
          ...
          <Step title="Debugging UI Issues">
            ...
            <Info>
              ...
              _"When editing the title in the side-by-side view, it doesn’t save. Fix this issue.”_
            </Info>
          </Step>
        </Steps>
      </Accordion>
            ...
            <Steps>
              ...
              <Step title="Step 2">
                ...
                <Info>
                  ...
                  _“Redesign the note editor to match this screenshot. Use a large title, white space for content, and dropdown-based tags.”_
                </Info>
              </Step>
            </Steps>
          </Step>
