...
[You can test it here. ](https://lovable.dev/links)
...
To generate a link to share you can use the link generator described below.

## **Link Generator**

For a simple link generation experience go to the [<u>Lovable Links tool</u>](https://lovable.dev/links). You write your prompt and upload images. The Lovable Link tool returns a URL you can share to generate an application with the same prompt and images.
