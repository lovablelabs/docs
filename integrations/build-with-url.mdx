...
description: "The Lovable API Build with URL feature is now in open Beta, enabling you to build and share Lovable apps using simple, shareable URLs."
icon: "window-restore"
...
Each link tells Lovable _what_ to build and optionally _what images to include_ — and Lovable takes care of the rest.
