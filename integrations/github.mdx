...
<Note>
  You don’t need GitHub to use Lovable — many creators build and launch entirely within Lovable.
</Note>
...
1. Sign in to your GitHub account or **authorize lovable.dev** to verify your GitHub identity.\
...
1. Click **Add organizations** and choose where to **install and authorize lovable.dev** — your personal account or one of your organizations.
2. Select whether to give access to **all repositories** or **only selected ones**.
2. Click **Install & Authorize** to grant Lovable permission to create and update repositories in your chosen account or organization.
