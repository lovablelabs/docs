...
Tell Lovable what type of store you want to create and mention you want to build it with Shopify. For example:

> Create an eCommerce store with Shopify for selling handmade scented candles.

Lovable prompts you to enable the Shopify connection. Press **Allow**. 

Lovable automatically creates a **sandbox store,** which won't accept real payments. Now, you can create, update, and delete your products immediately directly from Lovable. You can build and customize your storefront as long as you want before claiming your store on Shopify.
...
Add product images and ensure that you use representative images at all times. Add visuals using any of these options:
...
Now, you need to activate payments and complete your store setup in Shopify to start accepting real payments from your customers.

After the free trial, you need to get a paid Shopify subscription to continue selling products online. Shopify offers low starting fees (for example, \$1/month in the US for the first 3 months).
...
Publish your Lovable project and share it with the world.