...
description: "Use Lovable + Shopify to effortlessly build and launch new online stores from scratch"
icon: "shopify"
keywords: ["Shopify","Shopify integration","Shopify store","e-commerce platform","ecommerce","AI store builder","online store setup","Shopify integration","shopify sandbox","manage store","claim store","launch store"]
---

![Shopify Jp](/images/shopify.jpg)

From selling physical products to digital downloads, Lovable helps you build, customize, and iterate your new store using natural language, while Shopify handles payments, inventory, and logistics when you go live.
...
Before you start building your e-commerce store with **Lovable + Shopify**, here are a few important things to know:
...
By default, the Shopify integration is enabled for your workspace. You can manage the Shopify integration behavior and related Shopify settings for your projects in your user preferences: **Settings → Integrations → Shopify → User Preferences.**

### User preferences

The default setting for Shopify integration is **Ask each time**, meaning you decide whether to enable or disable the Shopify integration for each project. You can change your preference anytime from **Settings → Integrations → Shopify → User Preferences.**
...
> Create an e-commerce store **with Shopify** for selling handmade scented candles.
