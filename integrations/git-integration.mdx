...
In order to push commits to [GitHub](https://lovable.dev/blog/what-is-github), your project and Lovable will automatically pull them in and update the project. This allows you to make changes yourself, without asking the AI.
