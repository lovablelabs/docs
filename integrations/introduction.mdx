...
<CardGroup cols="3">
  ...
  <Card title="Groq / xAI" href="https://docs.x.ai/docs/overview">
...
View all list of publicly available APIs you can integration with Lovable [here](https://dashboard.mintlify.com/lovable-f9060f1e/lovable-f9060f1e/editor/main).