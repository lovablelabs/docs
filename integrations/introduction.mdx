...
| :------------- | :------------------------------------------------------------------------------------------------------------ | :---------------------------------------------------- |
| **Connector**  | Add capabilities and external services that your deployed app can call                                        | Stripe, Shopify, Supabase                             |
| **MCP Server** | Provide context, documents, and artifacts to the Lovable Agent during app creation and refinement             | Linear, Notion, Atlassian, n8n, any custom MCP server |
...
## **MCP connectors:  Provide context during app creation**

[MCP connectors](/integrations/mcp-servers) give the Lovable Agent access to content and artifacts inside the tools you already use, **during app creation**. They provide context so the agent can build apps that reflect your real workflows.
...
- **Custom MCP connectors:** connecting internal or third-party systems
...
- Managed in **Settings → Integrations → Personal connectors**
