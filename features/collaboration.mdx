...
<AccordionGroup>
  <Accordion title="How many members can one Workspace have?">
    Workspaces support unlimited members on all plans. Organizations on Business or Enterprise plans can optionally set custom limits for their workspace members.
  </Accordion>
