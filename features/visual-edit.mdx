...
For quick access, use the **Visual edits** shortcut in the prompt box. This starts the live preview so you can click on elements in the preview, edit them visually, and save when done.
...
5. Open the **Design view** from the `+` button next to Preview.
5. Switch between **Themes** and **Visual edit** tabs to work on your project’s design in the left-hand panel.
3. **Select a theme** or create your own and apply it to the project.
4. **Select an element** on the page and **edit** it in the left-hand panel.
