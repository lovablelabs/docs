...
To access themes, go to **Design view** from the `+` button next to Preview.
...
To access visual edits use the **Visual edits** shortcut in the prompt box or go to **Design view** from the `+` button next to Preview.
