...
<Steps>
  ...
  <Step title="Continue Setup">
    ...
    ![Connect your domain](features/assets/features/images/connect-entri.png)
  </Step>
  <Step title="Select Your DNS Provider">
    ...
    ![Choose your provider](features/assets/features/images/dns-provider.png)
  </Step>
...
3. When choosing a provider, scroll to the bottom and choose a manual setup.
   ...
   ![DNS settings](features/assets/features/images/dns-settings.png)
