...
- **Brand identity** - looks more trustworthy and professional
...
- You own a domain name. You can purchase one from any [supported provider](https://developers.entri.com/provider-list).
...
| **Verifying**        | DNS records were added and Lovable is waiting for DNS propagation.                                                                                                                                                                               | Click **Check status** to check the latest status and verify the DNS records.                                    |
| **Unable to verify** | DNS changes were not detected within one hour. This means your A and TXT records are still missing or have not propagated.<br /><br />**Note**: _DNS propagation can take up to 72 hours, although most updates are applied within a few hours._ | Click **Check again** to refresh the status and re-verify your DNS records.                                      |
