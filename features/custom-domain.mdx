...
| **Removed**          | This domain was removed because it was added to another project or DNS verification never completed (DNS records weren’t added correctly or didn’t finish propagating).                                                                           | Click **Reconnect** the connect the domain again.                                                                                                                                                           |
