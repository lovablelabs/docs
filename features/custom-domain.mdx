...
4. Now, you can connect your domain in two ways:
   - **Automatic setup with Entri**: Select your domain provider from the list, log in, and authorize Entri to update your DNS records. This includes a TXT record to verify ownership.
