...
- Your project is published. You cannot connect a domain to an unpublished project. See [Publish your app](/features/publish) for more information.
...
- You can **verify ownership** and have access to the DNS settings for the domain or subdomain you want to connect.
...
<AccordionGroup>
  ...
  <Accordion title="Can I connect a domain used by another project?">
    You, as long as you can verify ownership, you can connect a domain or subdomain used by another project, even if the project is deleted.
  </Accordion>
