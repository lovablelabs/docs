...
<Steps>
  ...
  <Step title="Select Your DNS Provider">
     Choose your domain provider from the list. If your provider isn’t listed, [please see these steps](/features/custom-domain#what-if-my-provider-isn’t-listed).
...
1. Open your Project Setting and go to Project > Settings > Domains and click Connect Domain.
...
For example, if you want to use blog.yourdomain.com, shop.yourdomain.com, and app.yourdomain.com, you’ll need to repeat the connection process for each subdomain in Project > Settings > Domains.
  ...
  3. Your domain will be disconnected from the project. Make sure to clear DNS setttings in your domain provider to completely clear the connection. 
  </Accordion>
</AccordionGroup>