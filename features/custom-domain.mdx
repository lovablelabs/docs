...
| **Unable to verify** | DNS changes have not been detected yet. <br />**Note**: _DNS changes may take up to _**_72 hours to propagate_**_, though most updates are live within a few hours._ | If it's been over an hour since you added the custom domain, click **Check again **to check the latest status and verify the DNS records again. |
...
| **Offline**          | Domain was **Live** but DNS records are no longer valid.                                                                                                             | Click **Recover**. Review displayed DNS records and fix them with your DNS provider.                                                            |
