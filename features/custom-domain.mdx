...
| **Verifying**        | Waiting for DNS records to propagate.                                                                                                                                                                                                                                                                                                        | Click **Check status** to check the latest status and verify the DNS records.                                    |
| **Unable to verify** | If DNS changes are not detected within one hour, the domain status automatically changes from **Verifying** to **Unable to verify**. This means the required DNS records are still missing or have not yet propagated.<br /><br />**Note**: _DNS propagation can take up to 72 hours, although most updates are applied within a few hours._ | Click **Check again** at any time to refresh the status and re-verify your DNS records.                          |
...
| **Offline**          | Domain was **Live** but DNS records are no longer valid. Your domain is no longer pointing to your project.                                                                                                                                                                                                                                  | Click **Recover**. Review displayed DNS records and update them with your DNS provider to reconnect your domain. |
...
<AccordionGroup>
  <Accordion title="My custom domain is connected, but my site isn't live. What should I do?">
    - Double-check your DNS settings by using for example [dnschecker.org](https://dnschecker.org/all-dns-records-of-domain.php). Sometimes DNS changes can take up to 72 hours to propagate. Go to **Project → Settings → Domains** to find the correct DNS settings.
