...
Lovable lets you connect your own domain or subdomain to your published project, so visitors can access it via a custom URL instead of the default `xxx.lovable.app` project URL.
...
Only verified owners can use a domain with their project:
