...
<Note>
  Lovable AI can only be used with [Lovable Cloud](https://docs.lovable.dev/features/cloud). It cannot be used with Supabase.
</Note>

Lovable AI is enabled by default when using Lovable Cloud. This means Lovable automatically adds AI functionality when requested, using **Gemini 2.5 Flash** as the default model. 

If you want to use a different model, you can specify that in the prompt when requesting AI functionality. For an overview of supported AI models, see [Supported AI models](https://docs.lovable.dev/features/ai#supported-ai-models).
...
You can track and manage your usage costs in **Settings → Usage.** For more details and examples see [Usage-based Cloud and AI pricing](https://docs.lovable.dev/features/cloud#usage-based-cloud-and-ai-pricing).
