...
By default, Lovable AI is enabled for your workspace and in your user preferences. This means Lovable automatically adds AI functionality when requested. You can manage Lovable AI behavior for your projects in your user preferences: **Settings → Integrations → Lovable AI → User preferences**.
...
The default setting for AI integration is **Always allow**, meaning Lovable AI will be automatically used in your projects. You can change your preference anytime from **Settings → Integrations → Lovable AI → User preferences**.
