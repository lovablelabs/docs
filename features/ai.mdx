...
To ensure reliable performance and fair access for all users, Lovable AI is subject to rate limits. Rate limits help us maintain system stability, prevent abuse, and deliver a consistent experience to everyone.

When your requests exceed the allowed rate, the server responds with a `429 Too Many Requests` status code and your request will not be processed.

These limits are more restrictive for free users, while paid plans offer higher thresholds and greater flexibility. 

- If you are on the free plan, you can upgrade your plan to increase the rate limits. 
-  If you are on a paid plan, and need more flexibility, contact [Lovable Support](https://lovable.dev/support).