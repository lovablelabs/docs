...
If you want to use a different model or combinations of models, you can specify that in the prompt when requesting AI functionality. For an overview of supported AI models, see [Supported AI models](https://docs.lovable.dev/features/ai#supported-ai-models).
...
Lovable AI uses **Gemini 2.5 Flash** as its default model, but you can prompt the agent use a different model or combinations of models.
