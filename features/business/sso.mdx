...
<AccordionGroup>
  ...
  <Accordion title="How can I find my tenant ID?">
    Your tenant ID is the value used in your login URL:\
    `https://lovable.dev/sso-login/{tenantId}`

    You can also find it in **Settings → Workspace → Identity** after you have configured your identity provider.
  </Accordion>
</AccordionGroup>