  ...
  <Tab title="OIDC">
    <Steps>
      ...
      <Step title="(Optional) Test configuration">
        Click **Test configuration**. If you configured everything accurately, the validation should be successful.
      </Step>
...
<Tabs>
  ...
  <Tab title="SAML">
    <Steps>
      ...
      <Step title="Finish SAML provider configuration">
        Click **Configure SAML Provider → Confirm & Enable SSO** to finish the configuration of Auth0 as your SAML SSO provider in Lovable.
      </Step>
    </Steps>
  </Tab>
</Tabs>
