...
Lovable instructs you to configure your identity provider before proceeding and displays the information you need to enter into your IdP.  See the respective OIDC and SAML tabs below for a quick reference.
