  ...
  <Tab title="SAML">
    <Steps>
      ...
      <Step title="Finish SAML provider configuration">
        Click **Configure SAML Provider → Confirm & Enable SSO** to finish the configuration of Okta as your SAML SSO provider in Lovable.
      </Step>
    </Steps>
  </Tab>
</Tabs>
  ...
  <Tab title="OIDC">
    <Steps>
      ...
      <Step title="Configure Allowed Callback URLs">
        Navigate to your application settings, add the **Allowed Callback URLs**: `https://auth.lovable.dev/__/auth/handler` , and click **Save**.
      </Step>
      <Step title="Provide Lovable with your IdP information">
        In Auth0, copy the following values from the **Settings** tab and enter them in Lovable.

        - Auth0 `Domain`  → Lovable `OIDC Issuer URL/Discovery Endpoint` (make sure to include `https://`)
      ...
      <Step title="Finish OIDC provider configuration">
        Click **Configure provider** to finish the configuration of Auth0 as your OIDC SSO provider in Lovable.
      </Step>
    </Steps>
  </Tab>
  <Tab title="SAML">
    <Steps>
      ...
      <Step title="Configure SAML2 Web App Add-on">
        - Navigate to **Addons**, and enable **SAML2 Web app**.
      ...
      <Step title="Provide Lovable with your IdP information">
        ...
        - Auth0 `Identity Provider Login URL`  → Lovable `SAML SSO Sing-on URL from your Idp`
...
<Tabs>
  <Tab title="SAML">
    <Steps>
      ...
      <Step title="Finish SAML provider configuration">
        Click \*\*Configure SAML Provider → Confirm & Enable SSO \*\*to finish the configuration of Microsoft Entra ID as your SAML SSO provider in Lovable.
      </Step>
    </Steps>
  </Tab>
</Tabs>
