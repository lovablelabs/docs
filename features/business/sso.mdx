...
<Note>
  ...
  **Identity provider (IdP)-initiated SSO** (starting from your IdP dashboard tile) is not supported.
</Note>
...
**Start in Lovable**: The workspace **owner**  or **admin** can set up SSO in **Settings → Workspace → Identity → Add SSO provider**, then choose **OIDC** or **SAML**.
