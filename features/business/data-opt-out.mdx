...
Customer data _may_ be used for model training and other business purposes as described in our [Terms of Service](https://lovable.dev/terms). **Only customer data that does not identify you _may_ be used.**
...
<AccordionGroup>
  <Accordion title="Does Lovable use my data to train AI models?">
    Customer data may be used for model training and other business purposes as described in our [Terms of Service](https://lovable.dev/terms). Only customer data that does not identify you _may_ be used.
