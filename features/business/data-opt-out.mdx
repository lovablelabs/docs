...
Customer Data may be used for model training and other business purposes as described in our [Terms of Service](https://lovable.dev/terms?utm_source=chatgpt.com).

Every customer and organization can decide how their data is used in Lovable.

- **Free and Pro plans**\
  Contact [Lovable Support](https://lovable.dev/support) if you want to opt out of model training or other training-related data usage.
- **Business and Enterprise plans**\
  If your organization prefers an additional layer of protection, you can opt out of any training-related data usage at the workspace level.
...
<AccordionGroup>
  <Accordion title="Does Lovable use my data to train AI models?">
    ...
    - **Free & Pro:** Customer Data may be used for model training unless you opt out by contacting [Lovable Support](https://lovable.dev/support).
    - **Business & Enterprise:** Customer Data may be used for model training unless your workspace enables **Data collection opt out**.
  </Accordion>
