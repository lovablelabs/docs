...
Lovable prompts you whenever a feature requires backend functionality. For example, if authentication or file storage is needed, you can:
...
You can configure Cloud integration tools from **Settings → Account → Tools**.
