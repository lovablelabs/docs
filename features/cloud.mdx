...
Use the advanced settings to view anad manage your current instance size. Larger instance sizes let your app handle more users and traffic. Keep in mind that your costs will increase as your usage increases.

- **Free plan users**: Upgrade to a paid plan anytime to upgrade instance size.
- **Paid plan users**: Choose a new size. You can choose between:
