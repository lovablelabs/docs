...
We’re actively iterating on both pricing and functionality based on user feedback — expect things to evolve over time.

  [Request Access](https://lovable-private-beta.lovable.app/) to the Private Beta.
</Warning>

Lovable Cloud lets you turn ideas into live apps—complete with databases, sign-ups and logins, storage, global delivery, and more—all built in and working together from the start.

Every workspace gets **$25 of free usage each month**, enough to keep multiple projects running side by side—such as:

- Personal blogs or portfolios
- Dashboards for your team
- Apps with accounts and logins for thousands of users
- Marketing sites handling tens of thousands of visitors

Or, in many cases, all of these at once—still without paying a cent.
...
- **Databases** — View tables and edit data
- **Edge Functions** — Run code on the edge, close to your users
- **File Storage** — Upload and manage files, images, and documents
- **User Management & Auth** — View users, track signups, and configure how users sign in to your app
- **Global Delivery** — Deliver your apps to users around the world
- **Custom Domains** — Use your own domain for your apps
- **Secrets Management** — Store and manage environment variables (like API keys) securely  
- **Security & Performance Suggestions** — Get security and performance recommendations  
- **Logs & Monitoring** — Monitor application logs to debug issues  
---
...
Every workspace gets $25 in free Cloud usage per month. That’s typically enough to run several personal or mid-sized projects, such as:  
...
- Or enable auto top-up for uninterrupted scaling  
...
Enable auto top-up on any paid plan. Your apps scale without interruption, and you only pay for usage beyond the free allowance. You can also set a monthly budget limit (e.g. $50). If you reach it, projects pause automatically—so you get growth with safety.  
