...
- **Cost-effective**: Manage multiple projects in one workspace with usage-based pricing. Every workspace starts with **\$25 free usage**, enough to launch and run multiple projects. Read more in **Usage-based Cloud and AI pricing **below**.**
