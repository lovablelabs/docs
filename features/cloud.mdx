...
- Top up and add funds to your worksapce balance (available for paid plans only)
...
3. Enter a custom amount which will be automatically added when your balance drops below \$10 (\$10 min, \$1000 max)
4. Set a monthly charge limit to ensure you are never charged more than that amount within a month (\$10 min, \$10,000 max)
3. Click**Save. ** Your default payment method will be automatically charged when your balance drops below \$10, provided you have not reached your monthly charge limit.

When you configure automatic top-up, you can visually track your monthly charges from the **Automatic top-up** screen. The monthly charge period reset on the first day of each month at 00:00 UTC (displayed in your timezone) and is not tied to the billing cycle of you subscription plan.
...
- **Paid plans:** top up your workspace balance any time or enable automatic top-up (in beta).
...
<AccordionGroup>
  <Accordion title="Do I have full control over my monthly expenses?">
    ...
    - **|Beta] Option 3: Top up automatically (seamless scaling)**

      \
      Automatically add funds when your balance drops below \$10, but remain in control of your monthly spend by adding a monthly spend limit. If you reach the limit, you will receive a notification and your projects will pause automatically. Your apps scale without interruption, and you only pay for usage beyond the free allowance. 
  </Accordion>
