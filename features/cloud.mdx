...
By default, Lovable Cloud is enabled for your workspace. You can manage Lovable Cloud behavior for your projects in your user preferences: **Settings → Connectors → Lovable Cloud → User preferences.**

### User preferences

The default setting for Cloud integration is **Ask each time**, meaning you decide whether to enable or disable Cloud for each project. You can change your preference anytime from **Settings → Connectors → Lovable Cloud → User preferences.**
...
You can change your Cloud tools preferences anytime from **Settings → Connectors → Lovable Cloud → User preferences.**
