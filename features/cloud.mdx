...
Workspace owners and admins on paid plans can top up balances either by doing a one-time top-up or configuring automatic top-ups.
...
Enable automatic top-up when your balance drops below \$10, and set a monthly limit to track your spending. 
...
4. Set a monthly spend amount to ensure you do not go over a certain limit (\$20 min, \$10,000 max)
3. Click**Save. ** Your default payment method will automatically be charged when the conditions are met.
