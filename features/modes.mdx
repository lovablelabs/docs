...
Agent Mode uses usage-based pricing, that you can read more about [here](/introduction/plans-and-credits#credit-usage). The cost of a message depends on its complexity to ensure you only pay for what you actually use. 
