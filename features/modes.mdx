...
Agent Mode uses usage-based pricing. The cost of a message depends on its complexity to ensure you only pay for what you actually use. 
...
While it still functions, it’s considered outdated and is generally not recommended, as Agent mode offers better performance and features.
