...
## 2. Plan Mode (ex Chat Mode)

**Plan Mode** is your development partner. It helps you think through problems, debug issues, and plan your product—directly within the Lovable Editor.

Unlike Edit Mode, Plan Mode is conversational. You can ask questions, brainstorm ideas, and get strategic guidance. Then, when you're ready, simply prompt: “`Implement the plan`”.

This switches you back to Edit Mode, where Lovable turns those ideas into working code.

<Note>
  Because these capabilities come with additional costs, messages in Plan Mode will now start counting towards your message limit.
</Note>
...
Click the **“Mode”** prompt at the bottom of your editor to toggle between Edit and Plan Modes.

![Chat Mode Switch Pn](/chat-mode-switch.png)

When you're in Plan Mode and say “implement the plan,” Lovable will seamlessly switch to Edit Mode and start building for you.

### ![Implement Plan Pn](/images/implement-plan.png)

**Top 15 Plan Mode Use Cases**
...
Plan Mode transforms the no-code/low-code experience, bridging ideas and fully functional products. It bridges the gap between great ideas and fully functional products, making complex software **accessible** to founders who previously relied on engineers.