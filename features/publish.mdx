...
<Note>
  On Business and Enterprise plans, only workspace owners and admins can publish
  projects.
</Note>
...
<Danger>
  Always perform a security review before publishing. This helps identify
  vulnerabilities that could expose sensitive data or allow unauthorized access.
  Learn more in [Security](/features/security).
</Danger>
