...
![lovable application overview](/Screenshot2025-04-04at12.11.55PM.png)
...
<CardGroup cols="2">
  ...
  <Card title="Prompt Engineering" icon="robot" href="/tips-tricks/prompting-one">
...
<CardGroup cols="2">
  <Card title="Feature requests" icon="bell-concierge" iconType="regular" href="https://feedback.lovable.dev/">
...
<CardGroup cols="2">
  ...
  <Card title="Product Announcement" icon="rss" href="https://lovable.dev/blog">
