...
- Shipped full support for SEO and Open Graph images so links (e.g. on X) now show proper card previews.
- Shipped a UI update to clarify that Supabase connections happen at the organization level.
