...
<Update label="Dec 10, 2025">
  ...
  **Bug fixes and improvements**
  ...
  - Updated default project visibility to private for all Lovable workspaces that previously had default project visibility set to public.
