...
- [Teams](https://docs.lovable.dev/user-guides/teams): Capability to collaborate on projects.
- Security checks when publishing projects.
...
- Improved [Chat mode](https://docs.lovable.dev/features/modes#2-chat-mode) is officially part of the Lovable chat flow.
