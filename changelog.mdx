---
title: "Changelog"
description: "Stay up to date with new features, improvements, and bug fixes shipped in Lovable."
...
<Update label="Dec 10, 2025">
  **A more Lovable dashboard**
  ...
  ![New Dashborad Dec 10 2025 Pn](/images/changelog-images/new-dashborad-dec-10-2025.png)
  ...
  - Enjoy new themes and theme selector (User settings → Appearance)
  - Use bulk actions: delete, move, remove from folders, transfer between workspaces

  **Opus 4.5 as the main Agent**

  We upgraded Lovable’s agent to Claude Opus 4.5, bringing major improvements to planning, design quality, and accuracy.

  This results in smoother development loops, higher publish rates, and better overall project success. Available to all users at no additional cost.

  **New custom domain actions**

  New actions are now available to help troubleshoot and recover domain configuration issues.
  ...
  **Cloud instance upgrade alerts**
  ...
  You now receive upgrade alerts when approaching your Lovable Cloud resource limits to ensure fast, reliable performance. We also added a detailed breakdown of usage (disk space, disk I/O, CPU) under Cloud → Advanced settings.

  **Connectors hub (formerly Integrations)**

  The Integrations page is now called Connectors, and the UI has been reorganized to clearly distinguish between:
  ...
  **Support for Miro MCP**

  You can now connect Lovable to your Miro account to access boards and diagrams directly from your workspace.
  ...
  **Manage permissions for personal connectors**

  You can now configure how Lovable Agent accesses your personal tool connections. This gives a clearer overview of available tools and lets you choose default behavior.
...
<Update label="Nov 5, 2025">
  **Lovable × Shopify Integration**
  ...
  See it in action with our merch store: lovable.dev/merch.
...
<Update label="Sep 1, 2025">
  ...
  **Smarter SEO for new apps** When you create a new app or webpage, Lovable now includes agentic SEO instructions that better respect SEO best practices. This helps your projects get better indexed on search engines and reach the audiences you’re building for.

  **Workspace viewer role (Pro+)** For Pro+ members, we’ve introduced a new Viewer role. Viewers can see workspace metadata, projects, and members, but can’t create or edit projects or invite others. It’s the perfect role for stakeholders who need visibility, but don’t need to edit projects.
