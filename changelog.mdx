...
- Improved credit tracking by making it explicit when you have reached 30 monthly credit cap and being explicit about when both you daily and monthly credits will renew
...
- Fixed GitHub branch rename blocking branch switching
