...
<Update label="11/26/2025">
  ...
  **Design view**
  ...
  ![Changelog Designview 11 18 25 Pn](/images/changelog-designview-11-18-25.png)

  This week we’re rolling out more design functionality starting with a new Design view, which provides a dedicated panel where you can seamlessly switch between your project's design tools. This includes updates to Visual edits, as well as new features including Themes and AI image generation.

  Design updates are rolling out progressively starting today, and should be available to all users by the end of the week.
  ...
  **Link existing Shopify stores**

  You can now connect your existing Shopify store to Lovable. The store connector has write access while collaborators get read-only access, keeping permissions predictable and secure.
