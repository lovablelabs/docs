...
* Improvements in visual edits that includes editing font weights, alignment and image resizing.

* Major improvements on versioning including auto scrolling, bookmarking edits, history redesign and restoring of new edits.

* Supabase syntax issue is resolved.

* 401 issue when logged out is resolved.

* Big improvement in the "Try to fix" button accessing network logs.
