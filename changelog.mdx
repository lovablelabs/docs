...
<Update label="11/18/2025">
  ...
  **Design view**
  ...
  The new Design view now provides a dedicated panel where you can seamlessly switch between your project's design tools. This includes the new Themes feature and the improved Visual edits functionality.

  [Learn more](https://docs.lovable.dev/features/visual-edit)
