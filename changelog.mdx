...
- Fixed issues with chat mode stopping in the middle of a response
- We fixed an issue where uninstalling the Lovable app from GitHub made it impossible to reconnect [GitHub](https://docs.lovable.dev/integrations/git-integration) to Lovable.
