...
<Update label="11/18/2025">
  ...
  **Design view**
  ...
  This week we’re rolling out more design functionality starting with a new Design view that brings your visual editing tools into one place. The new Design view now provides a dedicated panel where you can seamlessly switch between your project's design tools. This includes the new Themes feature and the improved Visual edits functionality.
