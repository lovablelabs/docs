...
---
 ...
 <Accordion title="2025">
  <Accordion title="December">
    <Update label="Update 1" description="v1.2.0">
      Content here...
    </Update>
    <Update label="Update 2" description="v1.1.9">
      Content here...
    </Update>
  </Accordion>
  
  <Accordion title="November">
    <Update label="Update 1" description="v1.1.8">
      Content here...
    </Update>
  </Accordion>
</Accordion>
...
<Accordion title="2024">
  <Accordion title="December">
    <Update label="Update 1" description="v1.0.5">
      Content here...
    </Update>
  </Accordion>
</Accordion>
  ...
  ## Lovable product updates from 2025
  
 ### November 2025
  
<Update label="Nov 26, 2025" description="MCP servers, Design tools, private projects, and more">
  **MCP servers**
...
<Update label="Nov 5, 2025" description="Shopify integration, better custom domain managements, Cloud & AI balance top-ups, and more">
...
<Update label="Jan 6, 2025">
 ...
 ## Lovable product updates from 2024
