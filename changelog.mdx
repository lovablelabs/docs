...
<Update label="Dec 10, 2025">
  ...
  **Opus 4.5 as the main Agent**
  ...
  We upgraded Lovable’s Agent to **Claude Opus 4.5**, bringing major improvements to planning, design quality, and accuracy. This results in smoother development loops, higher publish rates, and better overall project success. Available to all users at no additional cost.

  [Learn more](https://lovable.dev/blog/claude-opus-4-5-in-chat)

  **Chat before you build**

  ![Start From Chat Mode Dec 10 2025 Pn](/images/changelog-images/start-from-chat-mode-dec-10-2025.png)
