...
- We fixed an issue where uninstalling the Lovable app from GitHub made it impossible to reconnect GitHub to Lovable.
- Fixed bug causing the live preview window to go out of sync after AI edits.
- Fixed Supabase authentication session persistence issues by implementing full session object storage instead of just user data, ensuring longer-lasting authenticated connections.

## 14 - 03 - 2025

- Important changes to our UI to improve your experience. [Here's what's new](https://discord.com/channels/1119885301872070706/1120705825317593149/1350101727768084491).
- Introducing [custom domains](https://docs.lovable.dev/tips-tricks/custom-domain) in Lovable.
- [Labs Features](https://docs.lovable.dev/features/labs) now sync across devices, so any enabled feature on one device is available on all.﻿
