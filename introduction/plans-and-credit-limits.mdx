...
Please note that all plans all draw from the same shared pool. So when you upgrade for example, from Pro 1 (100 credits) to Pro 2 (200 credits), you don’t get an extra 200 credits. You simply gain access to the difference (in this case, 100 more credits).
