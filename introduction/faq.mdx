...
<AccordionGroup>
  <Accordion title="How do I find the Project settings?">
    You can find the **Project settings** by clicking your project name at the top left of the editor and then selecting **Settings**. Alternatively, use the keyboard shortcut:
...
<AccordionGroup>
  <Accordion title="What can I do with the Lovable API?">
    The Lovable API lets you build Lovable apps automatically using simple URLs. You can use it to:
    ...
    Learn more in our docs: [Lovable API – Build with URL](https://docs.lovable.dev/integrations/build-with-url)

    Or read our quick overview on the blog: Introducing the Lovable API - Build with URL
  </Accordion>
</AccordionGroup>
