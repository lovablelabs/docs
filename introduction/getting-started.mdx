  ...
  <Accordion title="Revert a change or edit a message and revert to use a different approach">
    ...
    <Steps>
      <Step title="Revert to past versions instantly or go with a different approach">
        You can preview an older working version and then revert to that version if needed, or edit a past message and revert to explore a different approach. Nothing gets lost — all changes made after that point stay in the chat and can be reapplied anytime any.
      </Step>
