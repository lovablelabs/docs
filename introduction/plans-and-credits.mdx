...
| 7,500           | \$3,300         | \$33,300 (\$2,750/month) |
...
The grey portion of the bar indicates the amount of credits that have already been used, while the blue sections show the different types of remaining credits. 
Hovering over each colored section will display a tooltip indicating the credit type and the exact number of credits available for that type.
