...
<AccordionGroup>
  ...
  <Accordion title="How can I upgrade my subscription?">
    To upgrade your subscription click your profile icon top right of the dashboard → Settings → Plans & Billing, or visit [this page](https://lovable.dev/?settings=billing). 
    Choose your desired amount of credits in the credits per month dropdown and then click "Upgrade". Complete the upgrade in the Stripe portal.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="I've upgraded but haven't received any credits?">
    You will receive credits only if you upgrade to a plan with a higher credit allowance. If you’ve upgraded to such and still haven’t received your credits, please reach out to support on [support@lovable.dev](mailto:support@lovable.dev).
  </Accordion>
</AccordionGroup>
