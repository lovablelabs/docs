...
<AccordionGroup>
  ...
  <Accordion title="Can I invite others to collaborate on my project?">
    Yes, you can share your project’s preview link. However, full collaboration features depend on your Lovable plan.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="What is the difference between Lovable & Bolt.new?">
    People say Lovable has higher quality outputs, ship faster, better at full stack and more. That's kind of the break-down why we would recommend Lovable:
    ...
    Bolt is still good, but [<u>Lovable.dev</u>](http://lovable.dev/) feels more full-stack ready and thoughtful.
  </Accordion>
