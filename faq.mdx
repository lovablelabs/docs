...
<AccordionGroup>
  ...
  <Accordion title="Can I use Lovable with a custom domain?">
    Yes, but currently, you must manually set up custom domains using **Vercel, Netlify, or other hosting services**. Lovable is working on a more streamlined custom domain solution.
  </Accordion>
