...
<AccordionGroup>
  <Accordion title="What should I do if I get an error message?">
    Click the **Try to Fix** button. If the error persists, use the **Chat Mode** to ask the AI for help or check Lovable's documentation.
  </Accordion>
  <Accordion title="How do I stop the AI from repeating failed fixes?">
    Describe the issue in detail via **Chat Mode** and specify how you want the AI to fix it.
  </Accordion>
  ...
  <Accordion title="Can I contact support?">
    Yes, Lovable provides a [**support system**](https://lovable.dev/support) for platform-related issues. If you need help with your project, the [**Discord community**](https://discord.gg/lovable-dev) is a great place to ask.
  </Accordion>
</AccordionGroup>
