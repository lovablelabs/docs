...
All authentication decisions, token validation, and user verification should happen on the server side, not in the browser. Client-side authentication can be easily bypassed or manipulated.
...
### Ensure that internal apps have "visibility" set to "workspace"

For applications that should not be publicly accessible:

- **Set project visibility of internal apps to "Workspace" in project dashboard**
- **Verify they are not published to the internet**
- **Use proper authentication for all internal tools**
- **Regularly audit access to private applications**
