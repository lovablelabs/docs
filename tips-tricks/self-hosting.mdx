---
title: "Self-hosting: Run your Lovable Cloud project anywhere"
description: "Deploy and manage your Lovable Cloud projects on your own infrastructure"
icon: "door-open"
---

[Lovable Cloud](https://docs.lovable.dev/features/cloud) is designed for speed, simplicity, and reliability. You can build, host, and scale confidently, knowing you can take your project with you.

This guide explains how you can self-host and move your Lovable Cloud project to another provider, for example Supabase.
...
2. In Supabase, go to **Storage** and upload files to corresponding buckets.
