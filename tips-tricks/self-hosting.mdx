...
| User accounts                     | Not supported                | You can export user data from the database, but you cannot export user passwords. Plan the migration **before onboarding real users.** |
