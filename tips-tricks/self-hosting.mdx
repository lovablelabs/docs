...
| User accounts                     | Manual, partial              | You can export user data from the database, but you cannot export user passwords. We recommend you plan the migration before onboarding real users. |
