...
<Warning>
  After migrating your project to your own Supabase instance, you'll need to continue development in your local environment or preferred IDE. Lovable will remain connected to the original Lovable Cloud database, so making changes in Lovable after migration would not sync with your new Supabase setup.
</Warning>
