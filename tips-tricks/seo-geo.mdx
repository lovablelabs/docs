...
<AccordionGroup>
  ...
  <Accordion title="Will a custom domain help my site rank better?">
    ...
    If SEO is part of your strategy, switching to a custom domain is one of the most impactful upgrades you can make. See [Custom domains](https://docs.lovable.dev/features/custom-domain) for setup details.
  </Accordion>
