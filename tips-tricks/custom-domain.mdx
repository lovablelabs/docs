...
- If you make more than 100 edits per 24 hours in Lovable, its likely you will hit the 100/day deployment limit in Vercel as well (it builds your development branch but doesn't deploy it). If you do, ask Lovable chat to build you vercel.json file which will force Vercel to not build development builds at all. DM one of our Community Champions, mayuronx, for more details if you want or search the Discord for "vercel.json" and you will find a post by mayuronx
