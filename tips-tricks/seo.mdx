  ...
  <Accordion title="Custom Sitemaps for Search Engine Indexing">
    ...
    **How to Generate a Sitemap in Lovable:**
    ...
    <Steps>
      ...
      <Step title="Step 3">
        Submit the sitemap **Google Search Console** under "Sitemaps" using the URL https://[yourdomain]/sitemap.xml (replace [yourdomain] with your custom domain). Note that if your sitemap has another name, you need to replace "sitemap.xml" with this name. This can be seen in code viewer under the public file.
      </Step>
      <Step title="Step 4">
