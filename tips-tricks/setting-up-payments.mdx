...
<Steps>
  ...
  <Step title="Step 2">
    ...
    - Add two subscription tiers - Starter $15 per month, Enterprise $49 per month
...
<Note>
  Subscriptions are always linked to the authenticated user's <code>
    id
  </code>
   in Supabase for secure, role‑based access.
  Webhooks are only added if you explicitly ask for them.
</Note>
