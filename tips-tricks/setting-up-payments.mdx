...
<Note>
  **Please note**
  Stripe integration doesn’t work in preview. To test the integration, make sure to deploy. You should also make sure to be in test mode in Stripe when testing.

  When testing payment, 4242 4242 4242 4242, any 3 digits as CVC and any future date will work as a card.
</Note>
