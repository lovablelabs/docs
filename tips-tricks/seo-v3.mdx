...
Google Search Console (GSC) shows how Google crawls, indexes, and ranks your site. It’s a key tool for tracking SEO performance and spotting technical problems. Lovable doesn’t integrate with GSC automatically, so you need to set it up manually.
...
<Accordion title="How to set up and use GCS for monitoring and maintenance">
  ...
  **Use the URL Inspection tool** 
  ...
  6. Open **View Tested Page** to check:
     - Screenshot of what Googlebot sees
     - Rendered HTML 
     - Console errors
     - Blocked resources
  5. Click **Request Indexing** for new or updated pages (rate limited)
